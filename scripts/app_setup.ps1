...
Write-Host ""
Write-Host "Unified Windows launcher:"
Write-Host "  powershell -ExecutionPolicy Bypass -File scripts\run_app.ps1 -Mode client"
Write-Host "  powershell -ExecutionPolicy Bypass -File scripts\run_app.ps1 -Mode local"
Write-Host "  powershell -ExecutionPolicy Bypass -File scripts\run_app.ps1 -Mode server"
Write-Host ""
Write-Host "Windows local:  powershell -ExecutionPolicy Bypass -File scripts\run_in_windows_by_localMode.ps1  # API + static WebUI"
...
Write-Host "NAS Docker WebUI: Python API serves the static frontend directly"
Write-Host "NAS deploy: powershell -ExecutionPolicy Bypass -File scripts\deploy_nas.ps1 -HostName <ip> -Password <password>"
